...
export const generateName = () => {
  const maleFirstNames = ["Souradeep","Arijit","Aarav", "Vivaan", "Arjun", "Rohan", "Aryan", "Advait", "Raj", "Kishor","Anant", "Shrikant", "Rahul"];
  const femaleFirstNames = ["Aanya", "Ananya", "Advika", "Ishita", "Kiara", "Neha", "Shruti", "Ravi", "Manasi", "Radha", "Madhuri", "Swapnali"];
  const lastNames = ["De","Chowdhury","Sharma", "Patel", "Joshi", "Kumar", "Singh", "Verma", "Patil", "Jadhav", "Negi", "Dikshit", "Raj"];
