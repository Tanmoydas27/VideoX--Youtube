...
const Header = () => {
  ...
  return (
    <div className=" w-[100vw] box-border  h-[6vh] fixed bg-blue-200 lg:flex px-2 py-2 md:px-4 lg:px-8 lg:py-8 border-b justify-between text-2xl items-center" >
        ...
        <div className="flex w-[10%] md:w-[15%] lg:w-max items-center gap-3 lg:gap-5">
            ...
            <Link to='/' className="items-center font-bold gap-1 flex text-black">
